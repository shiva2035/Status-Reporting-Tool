...
<div class="panel panel-info" style="float:left;width:79%;margin-left:10;min-height:600;height:auto;margin-top:-15;">
		<div class="panel-heading">
			<h3 class="panel-title">View Outbox</h3>
		</div>
		...
		<%
		String query = "select * from box where from1='"+session.getAttribute("uname")+"'";
		...
		while(rSet.next()){
			...
			<div class="panel-heading">
			<h3 class="panel-title"><% out.println(rSet.getString("to1")); %></h3>
			</div>
			<div class="panel-body">
